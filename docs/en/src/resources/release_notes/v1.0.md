...
The overview and highlights below describe the APIs and features available in the `v1.0.0` tag.
Subsequent updates are listed under [v1.0 Patch Releases](#v10-patch-releases).
...
### v1.0.1 — September 22, 2026

[v1.0.1](https://github.com/antgroup/vsag/releases/tag/v1.0.1) is the first patch release in the 1.0 LTS series. It includes 17 changes covering index correctness, DiskANN memory use, and build reliability.

- **HGraph:** remove the `topk`-dependent upper bound on `ef_search` ([#2525](https://github.com/antgroup/vsag/pull/2525)), traverse bridges with non-finite distances ([#2806](https://github.com/antgroup/vsag/pull/2806)), and prevent stale entry points after force-removing tail nodes ([#2906](https://github.com/antgroup/vsag/pull/2906)).
- **Other index fixes:** reclaim BruteForce storage after force removal ([#2538](https://github.com/antgroup/vsag/pull/2538)), skip zero-distance SINDI range candidates ([#2715](https://github.com/antgroup/vsag/pull/2715)), and align Pyramid raw-vector retrieval ([#2760](https://github.com/antgroup/vsag/pull/2760)).
- **DiskANN:** avoid copying streams for size checks ([#2630](https://github.com/antgroup/vsag/pull/2630)) and bound closest-center block memory ([#2646](https://github.com/antgroup/vsag/pull/2646)).
- **Dependency configuration:** add pin-qualified third-party overrides ([#2686](https://github.com/antgroup/vsag/pull/2686)).
- **OpenBLAS and packaging:** update bundled OpenBLAS and stabilize x86 detection ([#2704](https://github.com/antgroup/vsag/pull/2704), [#2876](https://github.com/antgroup/vsag/pull/2876)), then repair manylinux dependency builds ([#2971](https://github.com/antgroup/vsag/pull/2971)).
- **Compiler compatibility:** fix GCC 15 header compilation ([#2976](https://github.com/antgroup/vsag/pull/2976)) and avoid a GCC 14 sparse duplicate-copy warning ([#2992](https://github.com/antgroup/vsag/pull/2992)).
- **CI and tests:** restore PR lint on the 1.0 branch ([#2488](https://github.com/antgroup/vsag/pull/2488)), scope the OpenBLAS workaround to regular TSan ([#2670](https://github.com/antgroup/vsag/pull/2670)), and tolerate INT8 cosine rounding in tests ([#2968](https://github.com/antgroup/vsag/pull/2968)).

See the [full v1.0.0...v1.0.1 changelog](https://github.com/antgroup/vsag/compare/v1.0.0...v1.0.1) and the [official release](https://github.com/antgroup/vsag/releases/tag/v1.0.1) for the complete PR list and contributor credits.
